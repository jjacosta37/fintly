    ...
    for i in range(len(transactions)):
        ...
        if (Transaction.objects.filter(belvo_id=transactions[i]['id']).exists() == False):
            ...
            tranObject = Transaction(
                ...
                amount=transactions[i]["amount"] or 0.0,
                type=transactions[i]["type"] or 'N/A',
                ...
                acc_category=transactions[i]['account']['category'] or "",
                currency=transactions[i]['account']['currency'] or 'N/A',
